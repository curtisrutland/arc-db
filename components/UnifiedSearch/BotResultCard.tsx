  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h3 className="font-semibold text-sm text-zinc-900 dark:text-zinc-50 truncate">{bot.name}</h3>
        <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 line-clamp-2">{bot.description}</p>
        <div className="flex items-center gap-2 mt-2">
          <span className="text-xs text-zinc-500 dark:text-zinc-400">{bot.type}</span>
          <span
